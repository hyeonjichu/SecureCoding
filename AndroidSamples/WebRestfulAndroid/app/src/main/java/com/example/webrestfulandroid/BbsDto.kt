...
class BbsDto(val seq:Int, val id:String?, val ref:Int, val step:Int, val depth:Int, val title:String?, val content:String?, val wdate:String?, val del:Int, val readcount:Int): Parcelable {
